    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 mb-8">
        ...
        <DashboardCard
          ...
          imageSrc="/PremImages/generate.svg"
          onClick={() => {
            setActiveCard(0);
        ...
        <DashboardCard
          ...
          imageSrc="/PremImages/content.svg"
          onClick={() => {
            setActiveCard(1);
            router.push("/content");
          }}
        ...
        <DashboardCard
          ...
          imageSrc="/PremImages/feedback.svg"
          onClick={() => {
            setActiveCard(2);
...
const DashboardCard = ({
  ...
  <div
    className={`rounded-[20px] border border-[#4A4A4A40]/75 ${
  ...
  >
    <div
      ...
      ${isActive ? "bg-[#DAE9FF]" : "bg-[#FFFFFF]"}`}
    >
      <div className="lg:w-30 lg:h-30 h-20 w-20  flex items-center justify-center mx-auto mb-4">
        <Image
          src={imageSrc}
          alt={title}
          width={90}
          height={90}
          className="lg:w-30 lg:h-30 w-20 h-20"
        />
      </div>
